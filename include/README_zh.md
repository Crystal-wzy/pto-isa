...
| [`TBROADCAST`](../docs/isa/comm/TBROADCAST_zh.md) | TODO | TODO | 是 | 是 | 是 | TODO |
...
| [`TGET`](../docs/isa/comm/TGET_zh.md) | TODO | TODO | 是 | 是 | 是 | TODO |
| [`TGET_ASYNC`](../docs/isa/comm/TGET_ASYNC_zh.md) | TODO | TODO | 是 | 是 | 是 | TODO |
...
| [`TNOTIFY`](../docs/isa/comm/TNOTIFY_zh.md) | TODO | TODO | 是 | 是 | 是 | TODO |
...
| [`TPUT`](../docs/isa/comm/TPUT_zh.md) | TODO | TODO | 是 | 是 | 是 | TODO |
| [`TPUT_ASYNC`](../docs/isa/comm/TPUT_ASYNC_zh.md) | TODO | TODO | 是 | 是 | TODO | TODO |
...
| [`TREDUCE`](../docs/isa/comm/TREDUCE_zh.md) | TODO | TODO | 是 | 是 | 是 | TODO |
...
| [`TTEST`](../docs/isa/comm/TTEST_zh.md) | TODO | TODO | 是 | 是 | 是 | TODO |
| [`TTRANS`](../docs/isa/TTRANS_zh.md) | 是 | TODO | 是 | 是 | 是 | 是 |
| [`TTRI`](../docs/isa/TTRI_zh.md) | TODO | TODO | 是 | 是 | 是 | 是 |
| [`TWAIT`](../docs/isa/comm/TWAIT_zh.md) | TODO | TODO | 是 | 是 | 是 | TODO |
