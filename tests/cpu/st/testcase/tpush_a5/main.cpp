...
static __aicore__ void main_incore_0_aic_BI_LEFTRIGHT(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3, int32_t v4)
{
    ...
    for (size_t v16 = (size_t)v14; v16 < ((size_t)v7); v16 += (size_t)v9) {
        Tile<
            TileType::Mat, float, 64, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
            CompactMode::Null>
            v17 = Tile<
                TileType::Mat, float, 64, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
        ...
        GlobalTensor<float, pto::Shape<1, 1, 1, 64, 64>, pto::Stride<32768, 32768, 32768, 512, 1>, pto::Layout::ND>
            v23 = GlobalTensor<
                float, pto::Shape<1, 1, 1, 64, 64>, pto::Stride<32768, 32768, 32768, 512, 1>, pto::Layout::ND>(
        ...
        Tile<
            TileType::Mat, float, 32, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
            CompactMode::Null>
            v24 = Tile<
                TileType::Mat, float, 32, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
        ...
        TPOP<
            TPipe<0, Direction::DIR_BOTH, 8192, 4, 2, false>,
            Tile<
                TileType::Mat, float, 32, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
                CompactMode::Null>,
        ...
        Tile<
            TileType::Left, float, 32, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
            CompactMode::Null>
            v25 = Tile<
                TileType::Left, float, 32, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
                CompactMode::Null>(v11, v8);
        ...
        Tile<
            TileType::Right, float, 64, 64, BLayout::RowMajor, -1, -1, SLayout::ColMajor, 512, PadValue::Null,
            CompactMode::Null>
            v29 = Tile<
                TileType::Right, float, 64, 64, BLayout::RowMajor, -1, -1, SLayout::ColMajor, 512, PadValue::Null,
                CompactMode::Null>(v8, v8);
        ...
        Tile<
            TileType::Acc, float, 32, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
            CompactMode::Null>
            v33 = Tile<
                TileType::Acc, float, 32, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                CompactMode::Null>(v11, v8);
...
static __aicore__ void main_incore_0_aiv_BI_LEFTRIGHT(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3, int32_t v4)
{
    ...
    Tile<
        TileType::Vec, float, 32, 32, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
        CompactMode::Null>
        v20 = Tile<
            TileType::Vec, float, 32, 32, BLayout::RowMajor, -1, -1, SLayout::NoneBox, 512, PadValue::Null,
    ...
    for (size_t v28 = (size_t)v17; v28 < ((size_t)v8); v28 += (size_t)v10) {
        ...
        GlobalTensor<float, pto::Shape<1, 1, 1, 32, 32>, pto::Stride<16384, 16384, 16384, 512, 1>, pto::Layout::ND>
            v35 = GlobalTensor<
                float, pto::Shape<1, 1, 1, 32, 32>, pto::Stride<16384, 16384, 16384, 512, 1>, pto::Layout::ND>(
        ...
        TADDS(v37, v21, v7);
        Tile<
            TileType::Vec, float, 32, 32, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
            CompactMode::Null>
            v40 = Tile<
                TileType::Vec, float, 32, 32, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
                CompactMode::Null>(v12, v12);
...
static __aicore__ void main_incore_0_aic_BI_NOSPLIT(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3, int32_t v4)
{
    ...
    for (size_t v16 = (size_t)v14; v16 < ((size_t)v7); v16 += (size_t)v9) {
        ...
        wait_flag(PIPE_MTE1, PIPE_S, EVENT_ID0);
        TPOP<
            TPipe<1, Direction::DIR_BOTH, 8192, 4, 2, true>,
            Tile<
                TileType::Mat, float, 32, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
                CompactMode::Null>,
    ...
    if (get_subblockid() == 0) {
        ...
        for (size_t v26 = (size_t)v17; v26 < ((size_t)v8); v26 += (size_t)v10) {
            ...
            GlobalTensor<float, pto::Shape<1, 1, 1, 32, 64>, pto::Stride<16384, 16384, 16384, 512, 1>, pto::Layout::ND>
                v33 = GlobalTensor<
                    float, pto::Shape<1, 1, 1, 32, 64>, pto::Stride<16384, 16384, 16384, 512, 1>, pto::Layout::ND>(
                    v1 + (v5 + v5 * (unsigned)v11 +
            ...
            TADDS(v35, v20, v7);
            Tile<
                TileType::Vec, float, 32, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
                CompactMode::Null>
                v38 = Tile<
                    TileType::Vec, float, 32, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
                    CompactMode::Null>(v12, v9);
...
static __aicore__ void main_incore_0_aic_BI_TOPDOWN(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3, int32_t v4)
{
    ...
    for (size_t v16 = (size_t)v14; v16 < ((size_t)v7); v16 += (size_t)v9) {
        ...
        wait_flag(PIPE_MTE1, PIPE_S, EVENT_ID0);
        TPOP<
            TPipe<2, Direction::DIR_BOTH, 8192, 4, 2, false>,
            Tile<
                TileType::Mat, float, 32, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
                CompactMode::Null>,
...
static __aicore__ void main_incore_0_aiv_BI_TOPDOWN(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3, int32_t v4)
{
    ...
    for (size_t v28 = (size_t)v17; v28 < ((size_t)v8); v28 += (size_t)v11) {
        ...
        TADDS(v37, v21, v7);
        Tile<
            TileType::Vec, float, 16, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
            CompactMode::Null>
            v40 = Tile<
                TileType::Vec, float, 16, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 512, PadValue::Null,
                CompactMode::Null>(v9, v10);
...
static __aicore__ void main_incore_0_aic_C2V_NOSPLIT(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3, int32_t v4)
{
    ...
    for (size_t v16 = (size_t)v14; v16 < ((size_t)v7); v16 += (size_t)v9) {
        ...
        wait_flag(PIPE_M, PIPE_FIX, EVENT_ID0);
        TPUSH<
            TPipe<3, Direction::DIR_C2V, 8192, 8, 2, true>,
            Tile<
                TileType::Acc, float, 32, 64, BLayout::ColMajor, -1, -1, SLayout::RowMajor, 1024, PadValue::Null,
                CompactMode::Null>,
...
TEST_F(TPUSH_A5Test, case_1) { test_tpush<1>(); }

TEST_F(TPUSH_A5Test, case_2) { test_tpush<2>(); }
