...
static void RunTPARTARGMINCase(const std::string& goldenDir)
{
...
TEST_F(TPARTARGMIN_Test, case_float_64x64_src1_32x32) { RunTPARTARGMINCase(GetGoldenDir()); }

TEST_F(TPARTARGMIN_Test, case_float_64x64_src1_32x32_tie) { RunTPARTARGMINCase(GetGoldenDir()); }
