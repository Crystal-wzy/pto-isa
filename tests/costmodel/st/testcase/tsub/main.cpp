...
TEST(TSub, float_64x64) { runTSub<float, 64, 64, 140.0f, 0.95f>(); }

TEST(TSub, int32_64x64) { runTSub<int32_t, 64, 64, 128.0f, 0.95f>(); }

TEST(TSub, half_16x256) { runTSub<half, 16, 256, 74.0f, 0.95f>(); }

TEST(TSub, int16_64x64) { runTSub<int16_t, 64, 64, 135.0f, 0.95f>(); }
