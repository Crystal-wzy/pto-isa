...
TEST(TMul, float_64x64) { runTMul<float, 64, 64, 145.0f, 0.95f>(); }

TEST(TMul, int32_64x64) { runTMul<int32_t, 64, 64, 128.0f, 0.95f>(); }

TEST(TMul, half_16x256) { runTMul<half, 16, 256, 77.0f, 0.95f>(); }

TEST(TMul, int16_64x64) { runTMul<int16_t, 64, 64, 136.0f, 0.95f>(); }
