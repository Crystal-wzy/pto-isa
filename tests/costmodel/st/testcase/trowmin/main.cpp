...
TEST(TRowMin, float_64x64) { runTRowMin<float, 64, 64, 480.0f, 0.90f>(); }
TEST(TRowMin, float_16x256) { runTRowMin<float, 16, 256, 293.0f, 0.90f>(); }
TEST(TRowMin, half_64x128) { runTRowMin<half, 64, 128, 481.0f, 0.90f>(); }
TEST(TRowMin, half_16x256) { runTRowMin<half, 16, 256, 190.0f, 0.90f>(); }
