...
TEST(TAdd, float_64x64) { runTAdd<float, 64, 64, 140.0f, 0.95f>(); }

TEST(TAdd, int32_64x64) { runTAdd<int32_t, 64, 64, 128.0f, 0.95f>(); }

TEST(TAdd, half_16x256) { runTAdd<half, 16, 256, 74.0f, 0.95f>(); }

TEST(TAdd, int16_64x64) { runTAdd<int16_t, 64, 64, 135.0f, 0.95f>(); }
