...
TEST(TRsqrt, case_float_64x64_64x64_64x64_inPlace_True) { runTRsqrt<float, 64, 64, 64, 64, true, 511.0f, 0.0f>(); }

TEST(TRsqrt, case_float_64x64_64x64_64x64_inPlace_False) { runTRsqrt<float, 64, 64, 64, 64, false, 75.0f, 0.95f>(); }

TEST(TRsqrt, case_half_64x64_64x64_64x64_inPlace_True) { runTRsqrt<half, 64, 64, 64, 64, true, 474.0f, 0.0f>(); }

TEST(TRsqrt, case_half_64x64_64x64_64x64_inPlace_False) { runTRsqrt<half, 64, 64, 64, 64, false, 41.0f, 0.95f>(); }
