...
TEST(TColSum, float_64x64_binary) { runTColSum<float, 64, 64, true, 329.0f, 0.90f>(); }
TEST(TColSum, float_1x3072_binary) { runTColSum<float, 1, 3072, true, 41.0f, 0.85f>(); }
TEST(TColSum, half_16x256) { runTColSum<half, 16, 256, false, 349.0f, 0.90f>(); }
